  ...
  return (
    <div className="min-h-[calc(100vh-86px)] mx-auto max-w-5xl h-full flex justify-center items-center sm:space-x-8 lg:space-x-16 p-6 sm:px-0">
      <div className="space-y-6 -mt-12">
        <h1 className="text-7xl font-semibold">Meet {import.meta.env.VITE_APP_NAME}.</h1>
        <h2 className="text-xl text-black">
          {import.meta.env.VITE_APP_NAME} is a starter kit made for <em>developers</em> who want to
          put their next SaaS idea on the market rapidly.
        </h2>
