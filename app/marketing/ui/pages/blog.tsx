...
export default function Blog({ posts }: { posts: BlogPost[] }) {
  return (
    <MarketingLayout>
      <div className="min-h-[calc(100vh-86px)] mx-auto max-w-5xl h-full flex flex-col items-center p-6 lg:my-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t py-8 lg:py-12">
          {posts.map((post) => (
